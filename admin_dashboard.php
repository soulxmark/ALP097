...
<head>
    ...
    <style>
        body { font-family: 'Times New Roman', serif; color: #333; padding: 40px; }
        ...
        .stat-item { text-align: center; flex: 1; border: 1px solid #eee; padding: 15px; }
        .stat-item span { display: block; font-size: 0.8em; text-transform: uppercase; color: #999; }
