...
<head>
  ...
  <style>
    ...
    #cdm-chat-btn {
      ...
      font-size: 1.6em; z-index: 8888;
      transition: transform .25s, box-shadow .25s;
    }
    #cdm-chat-btn:hover { transform: scale(1.1); box-shadow: 0 10px 32px rgba(212,175,55,0.6); }
    ...
    .cdm-chat-header-left { display: flex; align-items: center; gap: 10px; }
    .cdm-chat-avatar {
    ...
    .cdm-chat-name { font-family: 'Cormorant Garamond', serif; color: #d4af37; font-size: 1em; font-weight: 600; }
    .cdm-chat-status { font-size: .72em; color: rgba(255,255,255,.4); letter-spacing: .5px; }
    .cdm-chat-close { background: none; border: none; color: rgba(255,255,255,.4); font-size: 1.4em; cursor: pointer; line-height: 1; padding: 0; transition: color .2s; }
    .cdm-chat-close:hover { color: #d4af37; }
    ...
    .cdm-chat-messages::-webkit-scrollbar { width: 4px; }
    .cdm-chat-messages::-webkit-scrollbar-thumb { background: rgba(212,175,55,.3); border-radius: 2px; }

    .cdm-msg {
      max-width: 82%; font-family: 'Cormorant Garamond', serif;
      font-size: .97em; line-height: 1.55; padding: 10px 14px;
      border-radius: 14px; word-break: break-word;
    }
    .cdm-msg.bot {
      background: rgba(212,175,55,0.1);
      border: 1px solid rgba(212,175,55,0.18);
      color: rgba(255,255,255,.88); align-self: flex-start;
    ...
    .cdm-msg.typing { opacity: .6; font-style: italic; }
    ...
    #cdm-chat-input {
      ...
      font-size: .97em; padding: 9px 13px;
      outline: none; resize: none;
      max-height: 100px; line-height: 1.4;
      transition: border-color .3s;
    }
    #cdm-chat-input::placeholder { color: rgba(255,255,255,.25); }
    #cdm-chat-input:focus { border-color: #d4af37; }
    #cdm-chat-send {
      width: 38px; height: 38px; border-radius: 10px;
      background: #d4af37; border: none; cursor: pointer;
      display: flex; align-items: center; justify-content: center;
      font-size: 1.1em; transition: background .2s, transform .15s;
      flex-shrink: 0;
    }
    #cdm-chat-send:hover { background: #e8c84a; transform: scale(1.08); }
    #cdm-chat-send:disabled { opacity: .5; cursor: not-allowed; transform: none; }
    ...
    .cdm-qr:hover { background: rgba(212,175,55,.22); }

    @media (max-width: 480px) {
      #cdm-chat-window { width: calc(100vw - 20px); right: 10px; bottom: 90px; }
    }
  </style>
</head>
<body>
...
<div id="cdm-chat-window">
  ...
  <div class="cdm-chat-footer">
    <textarea id="cdm-chat-input" placeholder="Ask me anything…" rows="1"
