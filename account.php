...
<head>
  ...
  <style>
    ...
    .pay-btn:hover { background: #e8c84a; transform: translateY(-1px); }
    ...
    .pm-box {
      ...
      overflow: hidden; animation: pmUp .35s ease;
    }
    @keyframes pmUp { from{opacity:0;transform:translateY(24px)} to{opacity:1;transform:translateY(0)} }

    .pm-header {
      background: linear-gradient(135deg,#111,#1c1508);
      padding: 24px 28px; display: flex; align-items: center; justify-content: space-between;
    }
    .pm-header h3 { font-family:'Great Vibes',cursive; color:#d4af37; font-size:1.8em; margin:0; }
    .pm-header p  { color:rgba(255,255,255,.5); font-size:.85em; margin:4px 0 0; }
    .pm-close { background:none; border:none; color:rgba(255,255,255,.4); font-size:1.8em; cursor:pointer; line-height:1; padding:0; }
    .pm-close:hover { color:#d4af37; }

    .pm-body { padding: 28px; }
    .pm-amount { text-align:center; margin-bottom:24px; }
    .pm-amount .label { font-size:.78em; letter-spacing:2px; text-transform:uppercase; color:#aaa; }
    .pm-amount .value { font-size:2.2em; font-weight:700; color:#d4af37; line-height:1.2; }
    .pm-amount .order-ref { font-size:.85em; color:#bbb; margin-top:4px; }

    /* Method tabs */
    .pm-tabs { display:flex; gap:8px; margin-bottom:24px; }
    .pm-tab {
      flex:1; padding:12px 8px; border:2px solid #f0e8d0;
      border-radius:12px; background:#fdf9f0;
      cursor:pointer; text-align:center;
      font-family:'Cormorant Garamond',serif;
      font-size:.95em; font-weight:600; color:#888;
      transition:all .25s;
    }
    .pm-tab:hover { border-color:#d4af37; color:#d4af37; }
    .pm-tab.active { border-color:#d4af37; background:#d4af37; color:#111; }
    .pm-tab .tab-icon { font-size:1.4em; display:block; margin-bottom:4px; }

    /* Panels */
    .pm-panel { display:none; }
    .pm-panel.active { display:block; animation:panelIn .3s ease; }
    ...
    .pm-qr-wrap .qr-placeholder {
      ...
      border:3px dashed #d4af37; border-radius:12px;
      display:flex; align-items:center; justify-content:center;
      font-size:3em; color:#d4af37; background:#fdf9f0;
    }
    .pm-qr-wrap .pm-number { font-size:1.4em; font-weight:700; color:#111; letter-spacing:2px; }
    .pm-qr-wrap .pm-name   { color:#aaa; font-size:.9em; margin-top:4px; }
    .pm-instruction { background:#fdf9f0; border:1px solid #f0e8d0; border-radius:10px; padding:12px 16px; font-size:.88em; color:#666; line-height:1.6; margin-top:16px; text-align:left; }
    .pm-instruction strong { color:#d4af37; }

    /* Card panel */
    .pm-card-form .form-row { display:grid; grid-template-columns:1fr 1fr; gap:12px; }
    .pm-field { margin-bottom:14px; }
    .pm-field label { display:block; font-size:.75em; letter-spacing:1.5px; text-transform:uppercase; color:#aaa; margin-bottom:6px; }
    .pm-field input {
      width:100%; padding:11px 14px;
      border:1.5px solid #e8e0d0; border-radius:10px;
      font-family:'Cormorant Garamond',serif; font-size:1em; color:#111;
      outline:none; transition:border-color .3s;
      box-sizing:border-box;
    }
    .pm-field input:focus { border-color:#d4af37; }
    .pm-field input::placeholder { color:#ccc; }
    .card-icons { display:flex; gap:8px; margin-bottom:16px; }
    .card-icon { padding:4px 10px; border:1.5px solid #e8e0d0; border-radius:6px; font-size:.78em; font-weight:700; color:#555; }
    ...
    .pm-submit:hover { background:#e8c84a; transform:translateY(-2px); }
    .pm-submit:disabled { opacity:.6; cursor:not-allowed; transform:none; }

    /* Success state */
    .pm-success { display:none; text-align:center; padding:20px 0; }
    .pm-success .success-icon { font-size:3.5em; margin-bottom:12px; }
    .pm-success h4 { font-size:1.5em; color:#111; margin-bottom:8px; }
    .pm-success p  { color:#aaa; font-size:.95em; line-height:1.6; }
    ...
    @media (max-width: 560px) {
      ...
      .pm-card-form .form-row { grid-template-columns: 1fr; }
    }
  </style>
</head>
<body>
                ...
                <div class="order-body">
                  ...
                  <div style="text-align:right;margin-top:12px;">
                    <button class="pay-btn"
                      onclick="openPayment(<?php echo $order['order_id']; ?>,'<?php echo number_format($order['total_amount'],2); ?>')">
                      💳 Pay Now
                    </button>
                  </div>
                  <?php endif; ?>
