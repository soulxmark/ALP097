...
<head>
    ...
    <style>
        body { background: #111; color: #fff; font-family: 'Cormorant Garamond', serif; padding: 50px 20px; }
        .checkout-box { max-width: 600px; margin: 0 auto; background: #1a1a1a; padding: 40px; border: 1px solid #d4af37; border-radius: 15px; }
        h2 { font-family: 'Great Vibes', cursive; color: #d4af37; font-size: 3em; text-align: center; }
        
        .payment-options { display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin: 25px 0; }
        .pay-card { border: 1px solid rgba(212,175,55,0.3); padding: 20px; border-radius: 10px; text-align: center; cursor: pointer; transition: 0.3s; }
        .pay-card.active { background: #d4af37; color: #111; border-color: #fff; }
        
        #qr-section { display: none; text-align: center; margin-top: 20px; padding: 20px; background: #fff; border-radius: 10px; color: #111; }
        #qr-section img { width: 200px; height: 200px; }
        
        .confirm-btn { width: 100%; padding: 15px; background: #d4af37; border: none; color: #111; font-weight: bold; font-size: 1.1em; border-radius: 8px; cursor: pointer; margin-top: 20px; }
